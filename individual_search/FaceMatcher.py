...
class FaceMatcher:
    def __init__(self, distance_threshold=0.5):
        ...
        self.person_found_path = "static/person_found"  # Path for saving output frames
    ...
    def match_faces(self, frame):
        ...
        for face_encoding, face_location in zip(face_encodings, face_locations):
            ...
            if match_percentage > distance_threshold:
                ...
                similary.append(match_percentage)
            else:
        ...
        return output_frame,similary

    def search_in_video(self, reference_image_path, video_path, frame_rate=5):
        ...
        out = cv2.VideoWriter(self.output_file_path, fourcc, frame_rate, (frame_width, frame_height))
